...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.banuba.sdk.flutter.banuba_sdk.BanubaSdkPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin banuba_sdk, com.banuba.sdk.flutter.banuba_sdk.BanubaSdkPlugin", e);
    }
    try {
